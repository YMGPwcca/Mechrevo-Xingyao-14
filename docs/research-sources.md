...
| **S2** | `SRC-AUDIT`; file ID `file_00000000179c8206a3dc01afcd82478c`; collection locator `2026-09-13T20:57:03Z` | Static SetupUtility audit excerpts; source-reported PBS/CBS counts | Selected retrieved excerpts only. Source reports 204 PBS and 416 CBS controls; full tables not exported. | `2e0a8c1986d1aa4959c953aba89224f5997e35cd40c096fc58395e1aa6378e88` (5850 bytes) | [Setup inventory](bios-setup-options.md) |
| **S3** | `SRC-AML-C`; file ID `file_00000000177881fd8806584f4122e837`; collection locator `2026-09-16T08:31:21Z` | EC fields, GFNS/GPFM/SPFM, THMM, _Q16/_Q17/_Q40/_Q81 and helper excerpts | Selected EC fields, THMM, _Q16/_Q17/_Q40/_Q81, helper methods | `d527042e21d431f91fffeece6375e45a9740682a4121d32fb52f71c224afde65` (11859 bytes) | [ACPI/WMI](acpi-wmi.md); [thermal interfaces](thermal-performance.md) |
...
Export SHA-256 values for S2–S5, S7–S9 identify the exported excerpt or inventory record, not the original private source file unless explicitly stated.
...
The [documentation status register](documentation-status.md) is the canonical home for source-export, capture-recovery, identity, permission and publication gates. In particular, P01 remains `NEEDS_SOURCE_EXPORT`; P09, P10, P11, P16 and P17 remain evidence/identity gates. P18 is closed for the bounded E1/E2 statements above; it does not promote generic references into machine-specific claims. A named source or a planning lead is not promoted to a measured machine fact without the required source material.
